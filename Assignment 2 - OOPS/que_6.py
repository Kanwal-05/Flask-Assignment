# Create an object of the SavingsAccount class, and call the appropriate methods to deposit money, withdraw money, and calculate the interest
class BankAccount:
